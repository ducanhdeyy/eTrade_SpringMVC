	...
	<div class="wrapper page-collections-wrapper">
		...
		<main class="main-content">
			...
			<section class="page-title-area bg-img"
				data-bg-img="<c:url value="/resources/assets/img/photos/bg-page9.jpg"/>">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="page-title-content">
								...
								<div class="bread-crumbs">
									<a href="index">Home<span class="breadcrumb-sep">></span></a><span
										class="active">Shop Collection 01</span>
								</div>
							</div>
						</div>
					</div>
										...
										<div class="category-item hover-effect effect-style1">
											<div class="thumb">
												<a href="shop.html"><img
													src="<c:url value="/resources/assets/img/shop/category/38.jpg"/>"
													alt="Moren-Shop"></a>
									...
									<div class="row row-gutter-60">
											...
											<div class="product-item">
												<div class="product-thumb">
													<a href="shop-single-product.html"> <img
														src="<c:url value="/resources/assets/img/shop/65.jpg"/>"
												...
												<div class="product-info info-style2">
													<div class="content-inner">
														<h4 class="title">
															<a href="shop-single-product.html">Trend Coat</a>
														</h4>
														<div class="prices">
										...
										<div class="col-md-6 col-lg-4">
											...
											<div class="product-item">
												<div class="product-thumb">
													<a href="shop-single-product.html"> <img
														src="<c:url value="/resources/assets/img/shop/66.jpg"/>"
														alt="Moren-Shop"> <span class="thumb-overlay"></span>
													</a>
													<div class="product-action action-style3">
														<a class="action-cart ht-tooltip"
										...
										<div class="col-md-6 col-lg-4">
											...
											<div class="product-item">
												<div class="product-thumb">
													<a href="shop-single-product.html"> <img
														src="<c:url value="/resources/assets/img/shop/67.jpg"/>"
														alt="Moren-Shop"> <span class="thumb-overlay"></span>
													</a>
													<div class="product-action action-style3">
														<a class="action-cart ht-tooltip"
			...
			<section class="divider-area bg-overlay-black2-51 bg-img"
					...
					<div class="row">
						<div class="col-md-6 m-auto">
							<div class="divider-content divider-content-style6">
								<h2>NEW IN</h2>
								<h4>Maecenas pellentesque posuere mauris tincidunt orci,
									aliquet nam aliquet purus.</h4>
								<a href="product" class="btn-theme btn-border">View All</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="align-left">
									<div class="category-items-style15">
										...
										<div class="category-item hover-effect effect-style1">
											<div class="thumb">
												<a href="product"><img
													src="<c:url value="/resources/assets/img/shop/category/26.jpg"/>"
													alt="Moren-Shop"></a>
												<div class="effect-content"></div>
											</div>
											<div class="content">
			...
			<!--== Start Divider Area Wrapper ==-->
			<section class="divider-area bg-overlay-black2-51 bg-img"
				data-bg-img="<c:url value="/resources/assets/img/photos/bg-page7.jpg"/>">
				<div class="container">
					<div class="row">
						<div class="col-md-6 m-auto">
							<div class="divider-content divider-content-style6">
								...
								<div class="align-left">
									<div class="category-items-style15 mb-xs-30">
										...
										<div class="category-item hover-effect effect-style1">
											<div class="thumb">
												<a href="shop.html"><img
													src=" <c:url value="/resources/assets/img/shop/category/39.jpg"/>"
													alt="Moren-Shop"></a>
												<div class="effect-content"></div>
											</div>
											<div class="content">
			...
			<!--== Start Divider Area Wrapper ==-->
			<section class="divider-area bg-overlay-black2-51 bg-img"
				data-bg-img="<c:url value="/resources/assets/img/photos/bg-page8.jpg"/>">
				<div class="container">
					<div class="row">
						<div class="col-md-6 m-auto">
							<div class="divider-content divider-content-style6">
					...
					<div class="row featured-style3">
						<div class="col-sm-6 col-md-4">
							<div class="featured-item">
								<div class="content">
									<span class="icon"> <svg
											xmlns="http://www.w3.org/2000/svg" width="76" height="46"
											fill="none" viewBox="0 0 76 46">
									...
									<div class="inner-content">
										...
										<p>Lorem ipsum dolor sit amet, id pericula appe llantur
											eam, mea.</p>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6 col-md-4">
							<div class="featured-item mt-xs-30">
								<div class="content">
									<span class="icon"> <svg
											xmlns="http://www.w3.org/2000/svg" width="76" height="72"
											fill="none" viewBox="0 0 76 72">
											<path fill="currentColor"
												d="M64.733 71.123H11.267a4.432 4.432 0 0 1-4.422-4.42V31.614a1.081 1.081 0 0 1 1.081-1.08h60.147a1.081 1.081 0 0 1 1.082 1.08v35.089a4.432 4.432 0 0 1-4.422 4.42zM9.008 32.695v34.008a2.263 2.263 0 0 0 2.26 2.26h53.465a2.262 2.262 0 0 0 2.26-2.26V32.695H9.007z"></path>
											<path fill="currentColor"
												d="M73.085 32.695H2.915a2.755 2.755 0 0 1-2.753-2.749v-8.357a2.755 2.755 0 0 1 2.753-2.751h70.17a2.755 2.755 0 0 1 2.753 2.751v8.357a2.755 2.755 0 0 1-2.753 2.75zM2.915 21a.59.59 0 0 0-.59.59v8.356a.59.59 0 0 0 .59.59h70.17a.59.59 0 0 0 .59-.59v-8.357a.59.59 0 0 0-.59-.589H2.915z"></path>
											<path fill="currentColor"
						...
						<div class="col-sm-6 col-md-4">
							<div class="featured-item mt-sm-30">
								<div class="content">
									<span class="icon"> <svg
											xmlns="http://www.w3.org/2000/svg" width="76" height="74"
											fill="none" viewBox="0 0 76 74">
											<path fill="currentColor"
												d="M74.757 73.649H1.243a1.08 1.08 0 0 1-1.08-1.081V20.4a1.081 1.081 0 0 1 1.08-1.081h73.514a1.08 1.08 0 0 1 1.08 1.081v52.168a1.08 1.08 0 0 1-1.08 1.08zM2.324 71.487h71.352V21.48H2.324v50.006z"></path>
											<path fill="currentColor"
												d="M74.757 21.481H1.243a1.08 1.08 0 0 1-.865-1.73L14.607.785a1.081 1.081 0 0 1 .864-.432H60.53a1.081 1.081 0 0 1 .865.432l14.228 18.968a1.081 1.081 0 0 1-.865 1.73zM3.405 19.32h69.19L59.988 2.514H16.012L3.405 19.319z"></path>
											<path fill="currentColor"
												d="M47.19 21.481H28.81a1.082 1.082 0 0 1-1.059-1.297l3.784-18.968a1.08 1.08 0 0 1 1.06-.864h10.81a1.08 1.08 0 0 1 1.06.864l3.784 18.971a1.08 1.08 0 0 1-1.06 1.297v-.003zM30.128 19.32H45.87L42.52 2.514h-9.038L30.13 19.319z"></path>
											<path fill="currentColor"
												d="M47.19 41.848a1.08 1.08 0 0 1-.685-.245L38 34.653l-8.505 6.95a1.08 1.08 0 0 1-1.765-.836V20.4a1.08 1.08 0 0 1 1.08-1.081h18.38a1.08 1.08 0 0 1 1.08 1.081v20.367a1.08 1.08 0 0 1-1.08 1.08zM38 32.176c.25 0 .491.087.684.245l7.424 6.066V21.48H29.892v17.006l7.424-6.067a1.08 1.08 0 0 1 .684-.244z"></path></svg></span>
									<div class="inner-content">
