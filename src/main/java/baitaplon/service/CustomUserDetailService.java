...
import baitaplon.entities.User_Role;
@Service
public class CustomUserDetailService implements UserDetailsService {
	...
	private UserDetails loadUser(String username) {
        ...
        return new CustomUserDetails(grantedAuthoritySet, user.getEmail(), user.getPassWord(), user.getUserName(), user.getEnabled(),true,true,true);
	}
}